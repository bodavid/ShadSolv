  ...
  var
    ...
    renderShader = new GL.Shader('\
      ...
      ', '\
        ...
        void main() {\
          gl_FragColor = vec4(\n\
            0.5 + 0.5 * sin(texture2D(texture, coord).r / range * 12500.0),\n\
            0.5 + 0.5 * sin(texture2D(texture, coord).r / range * 15500.0),\n\
       //     texture2D(texture, coord).g,\n\
            0.5 + 0.5 * sin(texture2D(texture, coord).r / range * 25500.0),\n\
            1.0);\
        }\
      '),
...
//      $('#read-time-m1').text((readTime1).toFixed(5));
      $('#read-time-m2').text((readTime2).toFixed(5));
    },
